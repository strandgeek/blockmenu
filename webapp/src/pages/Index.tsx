...
import blockMenuLogo from "../assets/logo.svg";
    ...
    <div className="flex items-center justify-center h-screen w-screen">
      <div>
        ...
        <div className="flex w-full justify-center mt-8">
          <img src={blockMenuLogo} className="h-8" alt="BlockMenu Logo" />
        </div>
        <div>
          <div className="text-center w-full mt-4 text-gray-500">
            ...
            <div className="max-w-md mx-auto">
              BlockMenu is under development and will be launched prior the HackaTRON Season 4 end
            </div>
          </div>
        </div>
      </div>
