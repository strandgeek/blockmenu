...
contract BlockMenu is Ownable, MenuManageable, Billable, RestaurantStaff {
    ...
    ) public view returns (BillInfo[] memory) {
     ...
     */
    function getAccountCurrentBill(
        address account
    ...
    /**
     * @dev Returns the bill info
     */
    function getBillInfo(uint billId) public view returns (BillInfo memory) {
        return _getBillInfo(billId);
    }
}
